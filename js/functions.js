		...
		headerSchemeChanger: function( activeSlide, onWinLoad ){
			if( activeSlide.length > 0 ) {
				...
				if( activeSlide.hasClass('dark') ){
					...
					$('#header.transparent-header:not(.sticky-header,.semi-transparent,.floating-header)').addClass('light');
					if( !darkExists ) {
						$('#header.transparent-header.sticky-header,#header.transparent-header.semi-transparent.sticky-header,#header.transparent-header.floating-header.sticky-header').removeClass('light');
					}
					$headerWrap.removeClass('light');
				} else {
					if( $body.hasClass('light') ) {
						activeSlide.addClass('light');
						$('#header.transparent-header:not(.semi-transparent,.floating-header)').removeClass('light');
						$('#header.transparent-header:not(.sticky-header,.semi-transparent,.floating-header)').find('#header-wrap').addClass('light');
					} else {
						$('#header.transparent-header:not(.semi-transparent,.floating-header)').removeClass('light');
						$headerWrap.removeClass('light');
					}
